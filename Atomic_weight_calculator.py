...
atomic_masses = {
    ...
    "K": 39.098, "Ca": 40.078, "Sc": 44.955, "Ti": 47.867, "V": 50.942, "Cr": 51.996,
    ...
    "Es": 252, "Fm": 257, "Md": 258, "No": 259, "Lr": 266, "Rf": 267, "Db": 270,
...
if __name__ == "__main__":
    formula = input("Enter the molecular formula (e.g., H2O, C6H12O6): ")
    try:
        weight = calculate_molecular_weight(formula)
        print(f"The molecular weight of {formula} is: {weight:.3f} g/mol")
